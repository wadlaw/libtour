...
export default authMiddleware({
  ...
  publicRoutes: ['/', '/teams', '/teams/:path', '/events', '/events/:path', '/entrants', '/entrants/:path', '/api/webhooks/user', '/sign-in', '/prizewinners', '/halloffame', '/wallofshame',  '/eclectic', '/eclectic/:path', '/libeclectic', '/honoursboards'],
