...
export default authMiddleware({
  ...
  publicRoutes: ['/', '/teams', '/teams/:path', '/events', '/events/:path', '/events/:path/timeline', '/entrants', '/entrants/:path', '/api/webhooks/user', '/sign-in', '/prizewinners', '/halloffame', '/wallofshame',  '/eclectic', '/eclectic/:path', '/eclecticentrants/:path', '/libeclectic', '/honoursboards', '/podcast'],
